...
public class MenuTest {
	...
	@Test
	public void returnsInventoryCorrectlyDisplayMoonpieforItem5GetName() {
		String expected = "Moonpie";
		MainMenu mainMenu = new MainMenu(System.in, System.out);

		List<VendingMachineItem> inventory = mainMenu.setInventory();
		String result = inventory.get(4).getItemName();
